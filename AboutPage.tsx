...
const AboutPage: React.FC = () => {
  useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute('content', 'Learn about QR Generator Online. Our mission is to provide reliable, high-quality, and permanent QR code tools for designers and businesses without hidden costs.');
    }
  }, []);
