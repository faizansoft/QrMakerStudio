...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="animate-in pb-24 bg-white">
      {/* ═══════════════════════════ HERO HEADER ═══════════════════════════ */}
      <section className="bg-gradient-hero pt-16 pb-20 border-b border-slate-100 text-center">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-20">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block px-3 py-1 bg-green-100 text-accent text-xs font-bold uppercase rounded-lg">
          ...
          <div className="bg-slate-900 text-white rounded-2xl p-8 md:p-10 shadow-xl border border-white/10 space-y-6">
            <h3 className="text-2xl font-bold text-[#A8D5C2]">Why Creators Trust Us</h3>
            <ul className="space-y-4 text-sm md:text-base text-white/90">
              <li className="flex items-start gap-3">
                <span className="text-[#A8D5C2] font-bold text-lg">✓</span>
                <span><strong>Zero Expiration:</strong> Static QR codes work permanently forever.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#A8D5C2] font-bold text-lg">✓</span>
                <span><strong>Vector SVG Download:</strong> Export <Link to="/svg-qr-code-generator" className="text-[#A8D5C2] underline font-bold">Scalable Vector Graphics</Link> for crisp commercial print press production.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#A8D5C2] font-bold text-lg">✓</span>
                <span><strong>Logo Integration:</strong> Add your brand <Link to="/qr-code-with-logo" className="text-[#A8D5C2] underline font-bold">logo to QR codes</Link> with Level H error correction.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#A8D5C2] font-bold text-lg">✓</span>
        ...
        <section className="space-y-8 bg-slate-50 p-8 md:p-12 rounded-2xl border border-slate-200">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Supported Specialized QR Code Types</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 space-y-2 hover:shadow-md transition-all">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 space-y-2 hover:shadow-md transition-all md:col-span-2 lg:col-span-1">
              <h3 className="font-bold text-slate-900 text-base">
        ...
        <section className="space-y-8">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Advanced Design & Export Engine</h2>
            <p className="text-slate-600 text-base">
        ...
        <section className="bg-slate-900 text-white rounded-2xl p-10 md:p-14 space-y-6 shadow-2xl">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            <div className="inline-block px-3 py-1 bg-[#A8D5C2] text-slate-900 text-xs font-bold uppercase rounded-lg">
              Client-Side Security Architecture
            </div>
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-white">Browser-Based Local Processing</h2>
