    ...
    <div className="animate-in fade-in duration-700">
      ...
      <section className="relative overflow-hidden bg-white pt-16 pb-24">
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-500 font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
            We built this tool because traditional QR makers are often clunky and produce boring designs. QR Generator Online is a clean, professional studio that focuses on high-quality design and permanent links.
          </p>
      ...
      <section id="tools" className="max-w-7xl mx-auto px-6 py-12 scroll-mt-24">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 font-medium text-sm">Choose from our list of specialized tools to start creating your custom assets.</p>
        </div>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-display font-black text-slate-900 leading-tight">Great Experiences Start with a Simple Scan.</h2>
            ...
            <p className="text-slate-600 font-medium leading-relaxed">
              Our customizable QR codes make that transition seamless. We ensure every scan is a perfect extension of your professional brand.
            </p>
          ...
          <div className="relative p-1 bg-white rounded-[3rem] shadow-2xl border border-slate-200 overflow-hidden group">
            ...
            <div className="absolute bottom-10 left-10 right-10 p-6 bg-white/90 backdrop-blur-md rounded-2xl border border-white/50 shadow-xl">
               <p className="text-sm font-bold text-slate-900">"We updated our business materials with these styled codes. They look professional and were very easy to set up."</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
             <div className="space-y-8">
                <h2 className="text-4xl md:text-5xl font-display font-black text-slate-900 leading-tight">Branding Without Compromise</h2>
                <p className="text-slate-500 font-medium text-lg leading-relaxed">
                  Basic QR generators give you standard black squares. We give you tools to create assets that stand out. From business cards to WiFi access, your codes should be as unique as your brand.
                </p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-slate-500 font-medium leading-relaxed">Many QR sites deactivate your codes after a few weeks to try and force a subscription. We do not do that. Our generator produces standardized codes that will work as long as your destination exists.</p>
              ...
              <div className="pt-4">
                <Link to="/faqs-qr-code-generator">
                  <Button variant="outline" className="rounded-full px-8 text-xs font-black uppercase tracking-widest">See More in FAQ</Button>
                </Link>
              </div>
            </div>
            <div className="space-y-4">
