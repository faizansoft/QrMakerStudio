...
export const TOOL_RICH_DATA = {
  ...
  '/wifi-qr-code-generator': {
    ...
    faqs: [
      ...
      { q: 'How do I make a QR code for my WiFi password?', a: 'Type in your network name and password, choose the encryption type (WPA/WPA2/WPA3), and generate. The code carries the credentials, so scanning it joins the network — nobody has to read or type the password.' },
