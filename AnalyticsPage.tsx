    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="text-center">
          <div className="w-10 h-10 border-2 border-slate-200 border-t-accent rounded-full animate-spin mx-auto mb-3" />
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex border-b border-slate-200 gap-6">
          ...
          >
            ...
            Live Activity ({analytics.recentScans.length})
          </button>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Peak hours when audience scans most frequently</p>
                  </div>
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
                ...
                <p className="text-xs text-slate-400 mb-4">Direct camera scans vs web referrals</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
              <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 text-sm">Browsers & In-App Apps</h3>
        ...
        {activeTab === 'geo' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Top Countries */}
            <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
              <h3 className="font-bold text-slate-900 text-sm mb-1">Countries Breakdown</h3>
              <p className="text-xs text-slate-400 mb-4">Audience distribution across worldwide regions</p>
            ...
            {/* Top Cities */}
            <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
              <h3 className="font-bold text-slate-900 text-sm mb-1">Metropolitan Areas</h3>
              <p className="text-xs text-slate-400 mb-4">Top metro regions and cities</p>
              {analytics.cities.length === 0 ? (
                <p className="text-xs text-slate-400 py-6 text-center">No city data recorded yet.</p>
              ) : (
                <div className="space-y-3.5">
        ...
        {activeTab === 'stream' && (
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
            <div className="p-5 border-b border-slate-100 flex items-center justify-between">
              <div>
                <h3 className="font-bold text-slate-900 text-sm">Real-Time Scan Activity Stream</h3>
                <p className="text-xs text-slate-400">Sequential record of recent user scans</p>
              </div>
            ...
            {analytics.recentScans.length === 0 ? (
              <div className="p-12 text-center text-slate-400 text-xs">
                No scan events recorded yet. Scan your dynamic QR code to see live interactions!
              </div>
            ) : (
